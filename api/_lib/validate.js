...
const MAX = { name: 100, title: 200, department: 200, company: 200, country: 100, bio: 500, phone: 200, email: 200, website: 200, social: 100 };
...
export function validateCardData(input) {
  ...
  const data = {
    ...
    country: clamp(input.country, MAX.country),
